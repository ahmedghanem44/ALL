...
public class CoffeeExpertDAO {
	...
	public void storeToDatabase() {
		 Session ses = CoffeeExpertSession.getCoffeeSession();
	 ...
	 * 
	 * Query query =
	 * ses.createQuery("from CoffeeType where typeName='"+coffeType+"'"); CoffeeType
	 * cofType = (CoffeeType) query ; List<Coffee> list = cofType.getCoffe();
	 * List<String> coffeeNames = new ArrayList<String>() ; Iterator<Coffee> itr =
	 * list.iterator(); while(itr.hasNext()) { String name = itr.next().getName();
	 * coffeeNames.add(name); } return coffeeNames;
	 * 
	 * }
	 */
}